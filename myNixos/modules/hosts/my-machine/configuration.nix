{ self, inputs, ... }: {
  ...
  flake.nixosModules.myMachineConfiguration = { pkgs, lib, ... }:
    ...
    in
    {
      ...
      # Shell
      # ════════════════════════
      # Registers fish in /etc/shells (required for it to be a valid login shell)
      # and installs NixOS-specific completions and PATH integration.
      ...
      environment.systemPackages = with pkgs; [
        ...
        foot
        kitty
        # fish is omitted here — programs.fish.enable installs it system-wide
        htop
        mpv
        img
        pcmanfm
